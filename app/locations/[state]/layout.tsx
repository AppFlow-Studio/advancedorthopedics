...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = safeDescription(
    undefined,
    `Board-certified spine and orthopedic surgeons in ${stateInfo?.name || state}. ${stateClinics.length} locations in ${topCities}. PPO insurance accepted. Same-day appointments. Call today.`
  );
