        ...
        <section className="mb-16 px-6 lg:px-8">
          ...
          <ul className="space-y-4 text-lg text-[#424959]">
            ...
            <li className="flex items-start">
              <span className="text-[#0A50EC] mr-3">•</span>
              <span>
                <Link href="/injuries/car-accident" className="text-[#0A50EC] hover:underline font-medium">Sports injuries and overuse conditions</Link> (return-to-activity planning)
              </span>
            </li>
          </ul>
        </section>
