                ...
                <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-[24px]'>
                    {
                        ServicesAndExpertise.map((item, index) => (
                            <article className="flex flex-col p-4 rounded-[24px] space-y-[24px] bg-[#FAFAFA] text-[#252932]" key={item.title}>
                    ...
                    {loading ? (
                        ...
                        Array.from({ length: 6 }).map((_, idx) => (
                            <motion.div
                                ...
                                className="bg-[#FAFAFA] rounded-[24px] p-6 flex flex-col animate-pulse shadow-md min-h-[320px]"
                            >
                        ...
                        >
                            <svg width="80" height="80" fill="none" viewBox="0 0 80 80" className="mb-6">
                                <circle cx="40" cy="40" r="38" stroke="#5FBBEC" strokeWidth="4" fill="#FAFAFA" />
                            ...
                            <motion.h3
                                className="text-[#252932] text-2xl font-semibold mb-2"
                            ...
                            <motion.p
                                className="text-[#424959] text-lg text-center max-w-md"
                                initial={{ y: 10, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}
