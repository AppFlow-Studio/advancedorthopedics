...
import Policy2 from '@/public/InsurancePolicyCard2.png'
  ...
  return (
    <main className='w-full flex flex-col items-center justify-center bg-white h-full'>
        ...
        <div className="z-[1] flex flex-col w-full h-full text-left relative pt-32 md:pt-60">
          ...
          <div className=' px-6 xl:px-[80px] z-[2]'>
            <nav aria-label="Breadcrumb">
              <ol className='flex flex-row space-x-[4px] rounded-[62px] w-fit items-center justify-center px-[20px] py-[10px]' style={{ background : 'rgba(255, 255, 255, 0.50)' }}>
                <li className="text-[#022968]" style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 400 }}>Find Care</li>
                <li className="text-[#022968]" aria-hidden="true">/</li>
                <li className="text-[#2358AC]" style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 400 }}>Insurance Policy</li>
              </ol>
            </nav>
          </div>
          <div className=" px-6 xl:px-[80px] z-[2] flex flex-col space-y-[24px] items-center justify-start mt-[12px] w-[85%] xl:w-[45%] flex-wrap">
            <TextAnimate animation="blurInUp" by="word" once
              style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 400 }}
      ...
      <section className=" bg-[#FAFCFF] w-full h-full py-[50px] ">
        <div className="max-w-[1440px] w-full h-full px-6 xl:px-[40px] mx-auto flex flex-col lg:flex-row space-x-[60px] ">
          <div className=" lg:w-[50%] w-full  flex flex-col h-full">
            <h2 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, color : '#022968' }} className="text-3xl">
              We Accept Flexible & Comprehensive Insurance Providers
            </h2>
            <p style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, color : '#5B5F67' }} className="text-lg mt-[24px]">
      ...
      <section className='w-full h-full  mt-14 max-w-[1440px]  px-6 xl:px-[80px] space-y-2 flex flex-col '>
        <h2 className='text-[#022968] text-4xl md:text-5xl lg:text-7xl font-bold text-start w-full' style={{ fontFamily : 'var(--font-reem-kufi)', fontWeight : 500 }}>
        ...
        <div className=" grid grid-cols-1 lg:grid-cols-3 lg:gap-[32px] lg:gap-y-0 gap-y-[24px] ">
          <div className=" rounded-[24px] w-full bg-[#FAFAFA] p-[40px] flex-col  col-span-1 space-y-[40px] ">
            <div className="mt-[12px]">
              <h2 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, color : '#022968' }} className='text-4xl'>Concierge Services</h2>
            </div>
            <div>
          ...
          <div className=" rounded-[24px] bg-[#FAFAFA] p-10 flex flex-col col-span-2">
            <div className="">
              <p style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, color : 'black', lineHeight : 1.5 }} className="md:px-6 md:text-xl text-md">
            ...
            <div className=" mt-[40px] w-fit ">
              <div className=" max-h-[56px] h-full px-[16px] py-[16px] rounded-[62px] relative flex bg-[#0094E0] text-white text-[14px] font-semibold w-full justify-center items-center hover:cursor-pointer">
                <span style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, fontSize: "16px", lineHeight: "24px", letterSpacing: "0.02em" }}>Learn More</span>
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px] mt-[32px]">
          {ServicesAndExpertise.map((item,index) => (
            <motion.div className="flex flex-col p-4 rounded-[24px] space-y-[24px] bg-[#FAFAFA] hover:text-white text-[#022968] "
              whileHover={{ background : 'linear-gradient(177deg, #022968 -13.59%, #0094E0 109.86%)', scale: 1.02 }}
              key={item.title}
            >
              ...
              <div className=" flex flex-col space-y-[16px]">
                <h3 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500 }} className="text-3xl ">{item.title}</h3>
              </div>
              <div >
