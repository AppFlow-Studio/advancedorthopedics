...
import { sendCandidacyEmail } from '@/components/email/sendcontactemail'
import { Dialog, DialogContent, DialogTitle, DialogTrigger } from "@/components/ui/dialog"

const formSchema = z.object({
// Step 1 Questions
 condition : z.string().nonempty({ message : "Select a Option"}),
 age : z.string().nonempty({ message : "Select a Option"}),
 health : z.string().nonempty({ message : "Select a Option"}),
 smoking : z.string().nonempty({ message : "Select a Option"}),
// Step 2 Questions
