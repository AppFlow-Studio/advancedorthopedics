...
const faqItems : {question : string, answer : React.JSX.Element}[] = [
    ...
    },
    {
        ...
        answer : (
            <p>
                The good news? Most patients respond well to non-surgical options like physical therapy and medication. However, if these don’t work, minimally invasive surgery may be the next step. Mountain Spine & Care provides advanced treatments tailored to your unique condition.
                <br/><br/>A remote second opinion helps confirm your diagnosis, prevent unnecessary procedures, optimize treatment strategies, and bolster your confidence in making informed health decisions.
            </p>
        )
    },
...
const FreeMriReviewSteps = [

    {
        ...
        questions : [
            {
                question : "What condition do you have?",
