        ...
        <section className='w-full h-full flex flex-col items-center relative overflow-hidden bg-[#EFF5FF] py-[50px] px-6 xl:px-[80px]'>
          ...
          <div className='flex flex-col items-center justify-center max-w-[1440px] mt-[50px] w-full lg:px-[200px]'>
            ...
            <div className='bg-white p-[16px] space-y-[24px] flex flex-col w-full'>
              <h3 style={{ fontFamily: "var(--font-public-sans)", fontWeight: 400 }} className="text-[#5B5F67] text-lg text-left w-full">
                  ...
                  <div className='flex-col space-y-[16px] '>
                    {
                      ["100% Secure", "Your information is never shared", "We are HIPAA compliant", "We hate spam"].map((item) => (
                        ...
                        >
                          ...
                          <span style={{ fontFamily: "var(--font-public-sans)", fontWeight: 500 }} className="text-[#5B5F67] text-lg text-left w-full">
                            {item}
                          </span>
                        </div>
                      ))
