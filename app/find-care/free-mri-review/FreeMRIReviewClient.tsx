      ...
      <main className='w-full flex flex-col items-center justify-center bg-white h-full'>
        ...
        <section className='w-full h-full flex flex-col items-center relative overflow-hidden bg-[#EFF5FF] py-[50px] px-6 xl:px-[80px]'>
          <div className='px-6 xl:px-[80px] z-[2] flex w-full'>
            ...
            >
              <span className='text-black' style={{ fontFamily: 'var(--font-reem-kufi)', fontWeight: 400 }}>Find Care</span>
              <span className='text-black' style={{ fontFamily: 'var(--font-reem-kufi)', fontWeight: 400 }}>/</span>
              <span className='text-[#2358AC]' style={{ fontFamily: 'var(--font-reem-kufi)', fontWeight: 400 }}>Get a Free MRI Review</span>
            </div>
          </div>
                          ...
                          <FormItem>
                            <FormLabel>
                              <div key={question.question}>
                                <h3 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500 }} className="text-black text-lg text-left w-full">
                                  {question.question}
                                </h3>
                              </div>
                            </FormLabel>
            ...
            <div className=' flex flex-row p-[16px] w-full rounded-b-[24px] justify-between bg-white'>
              {
               ...
               >
                   ...
                   <h3 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, fontSize: "16px", lineHeight: "24px", letterSpacing: "0.02em" }}>Back</h3>
              ...
              >
                  ...
                  ConditionStep != 2 ?
                  <>
                      <p style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, fontSize: "16px", lineHeight: "24px", letterSpacing: "0.02em" }}>Next</p>
                      <div className=''>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12" fill="none">
                  ...
                  :
                  <p 
                      style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, fontSize: "16px", lineHeight: "24px", letterSpacing: "0.02em" }}
        ...
        <Dialog open={openAppointmentConfirm} onOpenChange={() => setAppointmentConfirm(!openAppointmentConfirm)} >
                    <DialogContent className=" rounded-[20px] p-[32px]" >
                        ...
                        <div className="bg-white flex flex-col space-y-[20px] items-center justify-center">
                            ...
                            <h1 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 700 }} className='text-[black] text-2xl'>
                                Your Appointment Request Is Confirmed
                            </h1>
                            <h3 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500 }} className='text-[#838890] text-md text-center'>
                            ...
                            >
                                <h3 style={{ fontFamily: "var(--font-reem-kufi)", fontWeight: 500, fontSize: "16px", lineHeight: "24px", letterSpacing: "0.02em" }}>Done</h3>
                            </div>
                        </div>
                    </DialogContent>
            </Dialog>
