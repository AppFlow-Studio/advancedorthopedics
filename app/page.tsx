  ...
  },
  {
    icon : () => (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M10.25 5.78336C10.25 2.6966 12.8563 0.25 16 0.25C19.1437 0.25 21.75 2.6966 21.75 5.78336C21.75 8.87012 19.1437 11.3167 16 11.3167C15.6288 11.3171 15.0889 11.2516 14.7245 11.1832C13.9352 11.6029 12.8291 11.8495 11.9384 11.6838C11.6783 11.6355 11.4628 11.4535 11.3716 11.2052C11.2803 10.9568 11.3267 10.6787 11.4936 10.4734C11.8198 10.0052 11.8505 9.6879 11.825 9.58778C10.853 8.60076 10.25 7.26183 10.25 5.78336ZM13.7422 6C13.7422 5.58579 14.078 5.25 14.4922 5.25H14.5003C14.9145 5.25 15.2503 5.58579 15.2503 6C15.2503 6.41421 14.9145 6.75 14.5003 6.75H14.4922C14.078 6.75 13.7422 6.41421 13.7422 6ZM16.7422 6C16.7422 5.58579 17.078 5.25 17.4922 5.25H17.5003C17.9145 5.25 18.2503 5.58579 18.2503 6C18.2503 6.41421 17.9145 6.75 17.5003 6.75H17.4922C17.078 6.75 16.7422 6.41421 16.7422 6ZM6.50027 7.75C4.56727 7.75 3.00027 9.317 3.00027 11.25C3.00027 13.183 4.56727 14.75 6.50027 14.75C8.43326 14.75 10.0003 13.183 10.0003 11.25C10.0003 9.317 8.43326 7.75 6.50027 7.75ZM12.0334 17.8258C11.5496 17.3899 10.6058 16.8991 10.1744 16.6756C7.92246 15.4413 5.07808 15.4413 2.8261 16.6756C2.39471 16.8991 1.45098 17.3899 0.967181 17.8258C0.668882 18.0946 0.324551 18.4993 0.260519 19.0385C0.189725 19.6346 0.482868 20.1474 0.94129 20.5494C1.68958 21.2055 2.61027 21.7499 3.8058 21.7499H9.19474C10.3903 21.7499 11.311 21.2055 12.0592 20.5494C12.5177 20.1474 12.8108 19.6346 12.74 19.0385C12.676 18.4993 12.3317 18.0946 12.0334 17.8258Z" fill="#0094E0"/>
      </svg>
    ),
    title : 'Comprehensive Support',
    body : 'From your first consultation to post-treatment recovery, we provide compassionate care at every stage of your journey.'
  },
  {
    icon : () => (
    ...
    body : 'No two bodies are the same — and neither are our treatments. We create custom plans tailored to your unique needs and goals.'
  },
  {
    icon : () => (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M11.0002 2C7.74885 2 5.31489 4.09486 5.02849 6.52063C5.15063 6.57303 5.26834 6.62684 5.37501 6.67566C5.73116 6.83478 6.40272 7.13482 6.6585 7.89191C6.75152 8.16724 6.75079 8.46163 6.75011 8.73554V13.2645C6.75079 13.5384 6.75152 13.8327 6.6585 14.1081C6.40272 14.8652 5.73116 15.1652 5.37501 15.3243C5.0121 15.4904 4.52133 15.7144 4.16362 15.7434C3.76625 15.7755 3.36396 15.6906 3.01491 15.4947C2.69791 15.3168 2.45992 15.0265 2.21887 14.7323C2.13171 14.6265 1.96671 14.4318 1.85082 14.2975L1.8508 14.2975L1.8508 14.2975L1.85075 14.2975C1.63889 14.052 1.39839 13.7733 1.20005 13.5137C0.8724 13.0849 0.544071 12.5711 0.380976 11.9741C0.206341 11.3348 0.206341 10.6652 0.380976 10.0259C0.499324 9.59269 0.71345 9.21039 0.996106 8.80913C1.26984 8.42054 1.73604 7.85098 2.19205 7.29711L2.19206 7.2971C2.26558 7.20386 2.36665 7.07569 2.44139 6.99009C2.57673 6.83505 2.76401 6.64608 3.01491 6.50526L3.0196 6.50263C3.31352 2.74952 6.91074 0 11.0002 0C15.0897 0 18.6869 2.74952 18.9809 6.50264L18.9855 6.50526C19.2364 6.64608 19.4237 6.83505 19.5591 6.99009C19.6338 7.07569 19.7349 7.20386 19.8084 7.2971L19.8084 7.29711C20.2644 7.85098 20.7306 8.42054 21.0044 8.80913C21.287 9.21039 21.5011 9.59269 21.6195 10.0259C21.7941 10.6652 21.7941 11.3348 21.6195 11.9741C21.4564 12.5711 21.1281 13.0849 20.8004 13.5137C20.6021 13.7733 20.3616 14.052 20.1497 14.2975L20.1497 14.2975L20.1496 14.2975C20.0338 14.4318 19.8688 14.6265 19.7816 14.7323L19.7816 14.7324C19.5443 15.0219 19.3099 15.3078 19.0002 15.4864V15.8C19.0002 18.3163 16.5419 20 14.0002 20H12.0002C11.4479 20 11.0002 19.5523 11.0002 19C11.0002 18.4477 11.4479 18 12.0002 18H14.0002C15.8768 18 17.0002 16.8183 17.0002 15.8V15.4914C16.868 15.4353 16.7403 15.3769 16.6255 15.3243C16.2693 15.1652 15.5977 14.8652 15.342 14.1081C15.2489 13.8327 15.2497 13.5384 15.2503 13.2645V8.73554C15.2497 8.46163 15.2489 8.16724 15.342 7.89191C15.5977 7.13482 16.2693 6.83478 16.6255 6.67566C16.7321 6.62684 16.8498 6.57303 16.972 6.52063C16.6856 4.09486 14.2516 2 11.0002 2Z" fill="#0094E0"/>
      </svg>
    ),
    title : 'Comprehensive Support',
    body : 'From your first consultation to post-treatment recovery, we provide compassionate care at every stage of your journey.'
    ...
    <main className=" w-full flex flex-col items-center justify-center bg-white h-full" >
       ...
       <section className="w-full max-w-[1440px] flex flex-col py-[50px] h-full px-[40px] ">
            ...
            >
              ...
              <div className=" flex flex-row space-x-[16px]">
                ...
                <button className=" bg-[#0094E0] border border-white rounded-full p-[18px] py-[20px] hover:cursor-pointer" onClick={() => setReviewsIndex(Math.min(Reviews.length - 1, ReviewsIndex + 1))}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12" fill="none">
            ...
            <Carousel className="w-full h-full mt-[60px]" index={ReviewsIndex}>
              <CarouselContent className="-ml-4 gap-x-8">

                {
                Reviews.map((item, index) => (
                <CarouselItem className="basis-1/2 pl-4 relative" key={index}>
                  <div className="w-full max-h-[454px] lg:h-[454px] relative flex items-end ">
                    <div className=" rounded-tr-[20px] rounded-tl-[20px] rounded-br-[80px] rounded-[80px] overflow-hidden max-h-[120px] max-w-[120px] lg:h-[120px] lg:w-[120px]  bg-[#F8FAF9] border-10 border-white ml-[50px] absolute -top-1">
        ...
        {/* Free MRI Card */}
          <div className=" rounded-[24px] bg-[#FAFAFA] p-[24px] flex flex-col w-[50%]">
              <div className="flex flex-col space-y-[24px]">
                ...
                className="text-5xl "
                >
                 Top Florida Clinic Free MRI Second Opinion
                </h1>
                ...
                <div className="flex flex-row w-full space-x-[11px] justify-center items-center">
                  ...
                  <button className="bg-white border hover:cursor-pointer border-[#022968] px-[32px] py-[16px] space-x-[10px] max-h-[56px] flex flex-row items-center justify-center rounded-[62px] w-[45%]">
                      <h1
                      style={{
                        fontFamily: "var(--font-inter)",
                        fontWeight: 400,
      ...
      <section className=" bg-[#FAFCFF] w-full h-full py-[50px] ">
        <div className="max-w-[1440px] w-full px-[40px] mx-auto">
          <div className=" flex flex-col w-full h-[680px] rounded-[24px] bg-gray-500 " />
        </div>      
      </section>
      {/*  */}
