        ...
        <section className='max-w-[1440px] w-full h-full flex flex-col relative overflow-hidden py-[50px] px-[80px] space-y-[24px]'>
          ...
          <div className=' flex flex-col space-y-[16px] '>
              ...
              >
                ...
                <br/><br/>
                At Advanced Orthopedics, we work to help you understand your symptoms, diagnose your condition and inform you of the various treatments. Below is an overview of the most common types of spine conditions, as well as other orthopedic conditions.              
              </h1>
          </div>
        </section>
