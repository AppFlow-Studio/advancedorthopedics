            ...
            {id && (
                <Link className="flex flex-col p-4 space-y-[32px]" href={`/blogs/${slug}`}>
                    ...
                    <div className=" flex flex-col space-y-[16px]">
                        ...
                        <div className=' flex flex-row flex-wrap w-full  space-y-1  items-center'>
                            {
                                BlogInfo.tags.map((tag) => (
                                    <span
                                        className=" self-end max-h-[56px] w-full h-full px-[32px] py-[16px] space-x-[10px] rounded-[62px] relative flex bg-[#FAFAFA] text-[#252932] text-[14px] font-semibold justify-center items-center"
                                        key={tag}
                                    >
                                        {tag}
                                    </span>
                        ...
                        <div className="bg-white border hover:cursor-pointer border-[#252932] px-[20px] py-[10px] space-x-[10px] flex flex-row items-center justify-center rounded-[62px] w-full text-[#252932]">
                            Read More
