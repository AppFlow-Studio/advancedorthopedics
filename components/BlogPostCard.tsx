        ...
        {id && (
            <Link className="flex flex-col p-4 space-y-[32px]" href={`/blogs/${slug}`}>
                ...
                <div className=" flex flex-col space-y-[16px]">
                    ...
                    <a href={`/blogs/${BlogInfo.title.replace(/\s+/g, '-').toLowerCase()}`} className="bg-white border hover:cursor-pointer border-[#022968] px-[20px] py-[10px] space-x-[10px] flex flex-row items-center justify-center rounded-[62px] w-full text-[#022968]">
                        Read More
