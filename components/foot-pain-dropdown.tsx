...
const footPainOptions: ConditionInfoProp[] = painconditions.filter(x => 
  ...
  x.slug === 'heel-pain-plantar-fasciitis' ||
  x.slug === 'achilles-tendon-pain' ||
  x.slug === 'flat-feet-pain' ||
  x.slug === 'ankle-arthroscopy-recovery-pain' ||
  x.slug === 'hammertoes-foot-pain' ||
  x.slug === 'ankle-replacement-surgery-pain' ||
  x.slug === 'diabetic-foot-ulcer-care'
)
