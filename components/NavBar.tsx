...
export default function NavBar() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 flex justify-center self-center lg:py-10 py-1 rounded-b-xl max-h-[128px] lg:h-[60px] ${isSidebarOpen ? 'bg-white' : 'bg-transparent'} transition-all duration-200 ${isScrolled ? ' ' : 'bg-transparent'}`}>
