...
export default function BookAnAppoitmentButton() {
  ...
  return (
      <Dialog open={open} onOpenChange={() => setOpen(!open)} >
        <DialogTitle onClick={handleOpen} className='max-h-[56px] group h-full px-[32px] py-[16px] rounded-[62px] relative flex bg-[#0094E0] text-white text-[14px] font-semibold w-full justify-center items-center hover:cursor-pointer'>
