...
export default function ConfirmationPopup({ openAppointmentConfirm, setAppointmentConfirm }: { openAppointmentConfirm: boolean, setAppointmentConfirm: (open: boolean) => void }) {
    return (
