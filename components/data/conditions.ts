...
export const Conditions : ConditionInfoProp[] = [
    ...
    {
      "title": "Back Pain",
      "body": "Back pain is a common issue affecting people of all ages and lifestyles. It ranges in intensity from a mild discomfort to severe pain that interferes with daily activities. Many in...",
      "slug": "backpain"
    },
    {
      "title": "Bulging Disc",
    ...
    {
      "title": "Sciatica",
      "body": "Pain that radiates along the path of the sciatic nerve, commonly caused by a herniated disc or bone spur compressing the nerve.",
      "slug": "sciatica"
    },
  ]