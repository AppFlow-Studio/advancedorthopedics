...
export const conditions: ConditionInfoProp[] = [
    ...
    },
    {
        ...
        detail: "Foraminal stenosis occurs when the small openings (foramina) on each side of your spine, through which nerve roots exit the spinal canal, become narrowed. This narrowing is often due to degenerative changes like bone spurs or <a href=\"/area-of-speciality/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated discs</a>, and it can compress or 'pinch' the exiting nerve root. This leads to symptoms along that nerve's pathway. At Mountain Spine & Orthopedics, our specialists use advanced imaging and a detailed neurological exam to precisely identify the location of the stenosis and create an effective treatment plan.",
    ...
    },
    {
        ...
        detail: "Synovitis is the inflammation of the synovial membrane, the thin layer of tissue that lines joints and produces lubricating fluid. This inflammation can be caused by trauma, overuse, or an underlying autoimmune condition like <a href=\"/area-of-speciality/rheumatoid-arthritis\" class=\"text-blue-600 hover:underline\">rheumatoid arthritis</a>. The resulting pain, swelling, and excess fluid can damage joint cartilage over time if left untreated. At Mountain Spine & Orthopedics, our diagnosis begins with a physical exam, often supplemented by complimentary imaging to detect inflammation and guide treatment.",
