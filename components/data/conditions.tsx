...
export const conditions: ConditionInfoProp[] = [
    {
        ...
        what_sym: "Symptoms often include <strong>chronic <a href=\"/conditions/lower-back-pain\" class=\"text-blue-600 hover:underline\">lower back pain</a></strong>, visibly uneven shoulders or hips, a noticeable <strong>spinal curve</strong>, and stiffness. Some individuals experience <strong>radiating pain</strong>, numbness, or weakness in the legs due to <strong>nerve compression</strong>.",
        risk_fac:
            "The risk of developing this condition increases with advanced age, a history of <a href=\"/conditions/degenerative-disc-disease\" class=\"text-blue-600 hover:underline\">degenerative disc disease</a> or spinal arthritis, low bone density (osteoporosis), and previous spinal surgery or significant injury. A sedentary lifestyle and smoking can also accelerate degenerative spinal changes.",
        diagnose:
    ...
    },
    {
        ...
        what_sym: "Common symptoms include the return of <strong><a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck</a> or <a href=\"/conditions/back-pain\" class=\"text-blue-600 hover:underline\">back pain</a></strong>, new stiffness near the original surgery site, reduced range of motion, and <strong>radiating numbness</strong>, <a href=\"/conditions/tingling-numbness\" class=\"text-blue-600 hover:underline\">tingling</a>, or <strong>muscle weakness</strong> in the arms or legs. These issues can worsen over time.",
        risk_fac:
    ...
    },
    {
        ...
        detail: "A <strong>lumbar herniated disc</strong> happens when the soft, gel-like center of a spinal disc pushes out through a tear in its tough outer layer, compressing a nerve in the lower back. This condition is a common cause of <a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>—radiating pain, numbness, or weakness that travels down the leg. It can result from gradual, age-related wear or a sudden injury. Mountain Spine & Orthopedics specializes in accurately diagnosing the location and severity of the herniation to create an effective treatment plan.",
        what_sym: "Symptoms often include <strong>sharp, shooting pain</strong> from the <a href=\"/conditions/lower-back-pain\" class=\"text-blue-600 hover:underline\">lower back</a> down one buttock and leg (<a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>), as well as <strong>numbness</strong>, <a href=\"/conditions/tingling-numbness\" class=\"text-blue-600 hover:underline\">tingling</a>, or <strong>muscle weakness</strong> in the affected leg or foot. Pain may worsen with sitting, bending, coughing, or sneezing.",
        risk_fac:
        ...
        why_choose_us:
            "At Mountain Spine & Orthopedics, our specialists are leaders in treating lumbar herniated discs and <a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>. We provide patients across Florida with a clear path to recovery, starting with a complimentary <a href=\"/find-care/free-mri-review\" class=\"text-blue-600 hover:underline\">MRI review</a> and a <a href=\"/find-care/second-opinion\" class=\"text-blue-600 hover:underline\">free second opinion</a>. Our focus on non-surgical and minimally invasive techniques means we are dedicated to finding the most effective, least disruptive solution to relieve your pain and restore your mobility.",
        schedule:
    ...
    },
    {
        ...
        detail: "<strong>Degenerative Disc Disease</strong> isn't a true disease, but a condition that develops as the <strong>intervertebral discs</strong> in the spine lose hydration, shrink, and lose their ability to cushion the vertebrae. These age-related changes can lead to <strong>chronic pain</strong>, reduced mobility, and <strong>nerve-related symptoms</strong> if a disc compresses a nerve. Mountain Spine & Orthopedics excels at diagnosing and treating DDD with precise imaging and personalized care focused on relieving pain and improving function. Left untreated, DDD can progress to <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated discs</a> or <a href=\"/conditions/spinal-stenosis\" class=\"text-blue-600 hover:underline\">spinal stenosis</a>.",
        what_sym: "Common signs include <strong>chronic neck or back pain</strong> that can worsen with sitting, bending, or lifting, and may radiate into the arms or legs (<a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>). Patients also frequently experience <strong>numbness</strong>, <a href=\"/conditions/tingling-numbness\" class=\"text-blue-600 hover:underline\">tingling</a>, and a general feeling of <strong>spinal stiffness</strong>.",
        risk_fac:
    ...
    },
    {
        ...
        prevent:
            "Maintaining strong neck and core muscles, practicing ergonomic workstation habits, treating <a href=\"/conditions/arthritis\" class=\"text-blue-600 hover:underline\">arthritis</a> early, avoiding tobacco, and staying physically active can help preserve spinal canal diameter and reduce the likelihood of developing symptomatic stenosis.",
        why_choose_us:
        ...
        schedule:
            "If <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a>, arm tingling, or balance issues are affecting your life, <a href=\"/find-care/book-an-appointment\" class=\"text-blue-600 hover:underline\">schedule a consultation</a> with Mountain Spine & Orthopedics today. We will review your complimentary MRI and provide a free second opinion to help you find the best path to recovery.",
    ...
    },
    {
        ...
        detail: "A <strong>cervical herniated disc</strong> occurs when the soft inner core of a disc in the neck pushes through a tear in its tough outer layer. This displacement can compress nearby <strong>nerve roots</strong> or the <strong>spinal cord</strong>, causing <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a>, <strong>radiating arm pain</strong>, and other neurological issues. This condition can develop from age-related wear, poor posture, or a sudden injury. At Mountain Spine & Orthopedics, we use high-resolution MRI scans to pinpoint the herniation and guide a customized treatment plan.",
...

    {
        ...
        detail: "<strong>Kyphosis</strong> is a <strong>spinal condition</strong> characterized by an excessive forward curvature of the upper back, leading to a rounded or 'humpback' appearance. While a gentle forward curve is normal, kyphosis occurs when this curve becomes exaggerated due to factors like <a href=\"/conditions/degenerative-disc-disease\" class=\"text-blue-600 hover:underline\">degenerative disc disease</a>, osteoporotic <a href=\"/conditions/spinal-compression-fractures\" class=\"text-blue-600 hover:underline\">compression fractures</a>, or poor posture. This abnormal alignment can strain back muscles, causing <strong>chronic pain</strong> and stiffness. At Mountain Spine & Orthopedics, we provide a thorough evaluation and tailored treatment plan to improve posture and relieve pain.",
    ...
    },
    {
        ...
        detail: "<strong>Osteoarthritis</strong>, often called 'wear-and-tear' arthritis, is a <strong>degenerative joint condition</strong> that occurs when the protective <strong>cartilage</strong> cushioning the ends of your bones wears down over time. This can affect any joint but is most common in the <strong>knees</strong>, <strong>hips</strong>, hands, and <strong>spine</strong>. As cartilage thins, bones can rub together, leading to pain, stiffness, swelling, and the formation of <a href=\"/conditions/spinal-bone-spurs\" class=\"text-blue-600 hover:underline\">bone spurs</a>. At Mountain Spine & Orthopedics, our assessment includes a focused exam and complimentary imaging to create a personalized treatment plan.",
    ...
    },
    {
        ...
        detail: "<strong>Sacroiliac (SI) joint dysfunction</strong> occurs when the joint connecting the base of the spine (sacrum) to the pelvis becomes inflamed or moves abnormally. This condition can produce pain that often mimics <a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a> or <a href=\"/conditions/lumbar-herniated-disc\" class=\"text-blue-600 hover:underline\">lumbar disc</a> issues, making an accurate diagnosis crucial. At Mountain Spine & Orthopedics, our specialists use provocative maneuvers and precision diagnostic injections to confirm the SI joint as the pain source, ensuring therapy is correctly targeted for effective relief.",
    ...
    },
    {
        ...
        what_sym: "Common symptoms include localized <a href=\"/conditions/back-pain\" class=\"text-blue-600 hover:underline\">back</a> or <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a>, which can be a <strong>dull ache</strong> or <strong>sharp pain</strong>. If the disc compresses a nerve, you may experience <strong>radiating pain</strong>, numbness, or weakness in the arms or legs.",
        risk_fac:
    ...
    },
    {
        ...
        schedule:
            "If sharp <a href=\"/conditions/back-pain\" class=\"text-blue-600 hover:underline\">back</a> or <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a> is limiting your life, <a href=\"/find-care/book-an-appointment\" class=\"text-blue-600 hover:underline\">schedule a consultation</a> with Mountain Spine & Orthopedics today. A complimentary MRI review and a free second opinion can help you find a path to healing and returning to the activities you love.",
        slug: "disc-tear",
        keywords: [
            "annular tear",
            "disc tear treatment",
    ...
    },
    {
        ...
        detail: "<strong>Hip dysplasia</strong> is a structural condition where the <strong>hip socket</strong> (acetabulum) is too shallow, preventing it from fully covering the 'ball' (femoral head) of the thighbone. This poor fit leads to <strong>instability</strong> and abnormal stress on the joint's cartilage and <a href=\"/conditions/labral-tears\" class=\"text-blue-600 hover:underline\">labrum</a>, often causing early-onset <a href=\"/conditions/arthritis\" class=\"text-blue-600 hover:underline\">arthritis</a>. While often diagnosed in infancy, mild cases can go unnoticed until adulthood. At Mountain Spine & Orthopedics, we use high-resolution imaging to map the socket's depth and create a personalized joint-preservation strategy.",
...

    {
        ...
        detail: "<strong>Facet joint disease</strong>, or <strong>facet arthropathy</strong>, is a condition that occurs when the small, stabilizing joints linking your vertebrae (<strong>facet joints</strong>) wear down or become inflamed. This is a form of <a href=\"/conditions/arthritis\" class=\"text-blue-600 hover:underline\">spinal arthritis</a> that can result from aging, injury, or repetitive stress. At Mountain Spine & Orthopedics, we evaluate each case with advanced imaging and diagnostic injections to provide a clear diagnosis and a patient-focused treatment plan for lasting pain relief.",
    ...
    },
    {
        ...
        detail: "<strong>Arthritis</strong> is an umbrella term for over 100 conditions that cause <strong>joint inflammation</strong>, pain, and disease. The most common forms are <a href=\"/conditions/osteoarthritis\" class=\"text-blue-600 hover:underline\">Osteoarthritis (OA)</a>, caused by cartilage breakdown, and <a href=\"/conditions/rheumatoid-arthritis\" class=\"text-blue-600 hover:underline\">Rheumatoid Arthritis (RA)</a>, an autoimmune disorder. Regardless of the type, arthritis can significantly impact mobility and overall well-being. Mountain Spine & Orthopedics is dedicated to identifying the specific type of arthritis you have to provide targeted, effective relief and improve your quality of life.",
    ...
    },
    {
        ...
        detail: "The lower back, or <strong>lumbar spine</strong>, bears more weight and stress than any other spinal region, making it highly vulnerable to injury and degenerative conditions. Common causes of pain include <strong>muscle strains</strong>, <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated discs</a>, <a href=\"/conditions/degenerative-disc-disease\" class=\"text-blue-600 hover:underline\">degenerative disc disease</a>, and <a href=\"/conditions/spinal-stenosis\" class=\"text-blue-600 hover:underline\">spinal stenosis</a>. At Mountain Spine & Orthopedics, a thorough history and physical exam, along with a complimentary high-resolution <a href=\"/find-care/free-mri-review\" class=\"text-blue-600 hover:underline\">MRI review</a>, help us pinpoint the exact cause of your pain and create a targeted, effective treatment plan.",
        what_sym: "Patients may feel a constant <strong>dull ache</strong> or episodic <strong>sharp pain</strong> in the lower back. Other common symptoms include stiffness, muscle tightness, and radiating pain, numbness, or tingling down the leg, a condition known as <a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>.",
        risk_fac:
    ...
    },
    {
        ...
        detail: "<strong>Sciatica</strong> is a symptom, not a condition itself, characterized by pain radiating along the path of the <strong>sciatic nerve</strong>. This nerve, the body's largest, can be compressed by a <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated disc</a>, <a href=\"/conditions/spinal-bone-spurs\" class=\"text-blue-600 hover:underline\">bone spur</a>, or <a href=\"/conditions/spinal-stenosis\" class=\"text-blue-600 hover:underline\">spinal stenosis</a> in the lower back. Accurately identifying the underlying cause is essential for effective treatment. At Mountain Spine & Orthopedics, our evaluation includes a physical exam and a complimentary <a href=\"/find-care/free-mri-review\" class=\"text-blue-600 hover:underline\">MRI review</a> to pinpoint the source of the nerve compression and relieve your pain.",
        ...
        schedule:
            "If radiating leg or <a href=\"/conditions/lower-back-pain\" class=\"text-blue-600 hover:underline\">lower back pain</a> is interfering with your mobility, <a href=\"/find-care/book-an-appointment\" class=\"text-blue-600 hover:underline\">schedule a consultation</a> with Mountain Spine & Orthopedics today. Receive a complimentary MRI review and a detailed second opinion to start on your path to resolving sciatica.",
    ...
    },
    {
        ...
        detail: "<strong>Foraminal stenosis</strong> occurs when the small openings (foramina) on each side of your spine, through which nerve roots exit the spinal canal, become narrowed. This narrowing is often due to degenerative changes like <a href=\"/conditions/spinal-bone-spurs\" class=\"text-blue-600 hover:underline\">bone spurs</a> or <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated discs</a>, and it can compress or 'pinch' the exiting <strong>nerve root</strong>. This leads to symptoms along that nerve's pathway. At Mountain Spine & Orthopedics, our specialists use advanced imaging and a detailed neurological exam to precisely identify the location of the stenosis and create an effective treatment plan.",
        what_sym: "Symptoms depend on the location of the <a href=\"/conditions/pinched-nerve\" class=\"text-blue-600 hover:underline\">pinched nerve</a> and can include <strong>radiating pain</strong> (<a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a> in the leg or radiculopathy in the arm), <strong>numbness</strong>, <strong>tingling</strong>, burning sensations, or <strong>muscle weakness</strong> in the affected limb.",
        risk_fac:
    ...
    },
    {
        ...
        what_sym: "Patients may experience a persistent ache or <strong>stiffness in the neck</strong>, sharp pain with sudden head movements, and <strong>headaches</strong> originating at the base of the skull. Pain, <a href=\"/conditions/tingling-numbness\" class=\"text-blue-600 hover:underline\">tingling</a>, or <strong>numbness</strong> that radiates into the shoulder, arm, or hand is also common.",
        risk_fac:
    ...
    },
    {
        ...
        detail: "<strong>Shoulder arthritis</strong> occurs when the smooth cartilage that covers the bones of the shoulder joint wears down, leading to <strong>pain</strong>, <strong>stiffness</strong>, and grinding. This degeneration can result from wear-and-tear, a past injury, or an inflammatory condition like <a href=\"/conditions/rheumatoid-arthritis\" class=\"text-blue-600 hover:underline\">rheumatoid arthritis</a>. At Mountain Spine & Orthopedics, our diagnosis includes a physical exam and advanced imaging to show joint space narrowing and bone spurs, which helps shape a personalized treatment strategy to restore motion and relieve pain.",
        ...
        treatment:
            "Initial management includes anti-inflammatory medications, physical therapy referrals to preserve motion, and <a href=\"/treatments/anti-inflammatory-injections-for-joint-and-spine-pain\" class=\"text-blue-600 hover:underline\">corticosteroid or biologic injections</a>. When symptoms persist or joint damage is advanced, our surgeons offer advanced surgical options, including minimally invasive <a href=\"/treatments/shoulder-arthroscopy\" class=\"text-blue-600 hover:underline\">arthroscopy</a>, partial joint resurfacing, or <a href=\"/treatments/resurfacing-shoulder-replacement\" class=\"text-blue-600 hover:underline\">shoulder replacement</a>. A reverse shoulder replacement may be used if a large <a href=\"/conditions/rotator-cuff-tear\" class=\"text-blue-600 hover:underline\">rotator cuff tear</a> is also present.",
        pain_info:
    ...
    },
    {
        ...
        detail: "<strong>Snapping hip syndrome</strong>, or <strong>coxa saltans</strong>, is caused by a muscle or tendon catching and releasing as it moves across a bony prominence in the hip. It can be caused by the IT band on the outside of the hip or the iliopsoas tendon in the front. While often painless initially, the repeated friction can lead to painful inflammation (<a href=\"/conditions/bursitis\" class=\"text-blue-600 hover:underline\">bursitis</a> or tendonitis). At Mountain Spine & Orthopedics, we use dynamic ultrasound and a physical exam to confirm the source and create a plan to restore smooth hip motion.",
...

    {
        ...
        detail: "<strong>Spinal bone spurs</strong> (osteophytes) are bony projections that develop along the edges of vertebrae, typically as a response to the joint degeneration seen in <a href=\"/conditions/osteoarthritis\" class=\"text-blue-600 hover:underline\">osteoarthritis</a>. While many bone spurs are asymptomatic, they can cause significant pain, stiffness, or <strong>radiating symptoms</strong> if they grow large enough to narrow the spinal canal or press on nearby nerves. At Mountain Spine & Orthopedics, our evaluation includes a detailed physical exam and complimentary imaging to identify the impact of bone spurs and guide treatment.",
        what_sym: "When symptomatic, bone spurs can cause localized <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck</a> or <a href=\"/conditions/back-pain\" class=\"text-blue-600 hover:underline\">back pain</a>, <strong>stiffness</strong>, and <strong>radiating pain, numbness, or weakness</strong> in the arms or legs. In severe cases, they can contribute to <a href=\"/conditions/spinal-stenosis\" class=\"text-blue-600 hover:underline\">spinal stenosis</a>, leading to issues with balance or walking.",
        ...
        prevent: "Maintaining good posture, engaging in regular low-impact exercise, managing weight, and treating underlying conditions like arthritis or <a href=\"/conditions/degenerative-disc-disease\" class=\"text-blue-600 hover:underline\">disc degeneration</a> early can help slow the progression of bone spur formation.",
    ...
    },
    {
        ...
        detail: "<strong>Spinal stenosis</strong> is a condition characterized by the <strong>narrowing of the spinal canal</strong>, most commonly in the neck (<a href=\"/conditions/cervical-spinal-stenosis\" class=\"text-blue-600 hover:underline\">cervical</a>) or lower back (<strong>lumbar</strong>) due to age-related changes like <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated discs</a>, thickened ligaments, or <a href=\"/conditions/spinal-bone-spurs\" class=\"text-blue-600 hover:underline\">bone spurs</a>. This narrowing places pressure on the <strong>spinal cord or nerve roots</strong>, leading to symptoms that may worsen over time. At Mountain Spine & Orthopedics, our specialists use complimentary imaging and a neurologic exam to confirm the stenosis and develop a personalized treatment plan.",
        ...
        schedule: "If you're experiencing back or <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a>, numbness, or difficulty walking, <a href=\"/find-care/book-an-appointment\" class=\"text-blue-600 hover:underline\">schedule a consultation</a> with Mountain Spine & Orthopedics today. Receive a complimentary MRI review and an expert second opinion to manage your spinal stenosis and regain mobility.",
    ...
    },
    {
        ...
        detail: "<strong>Tingling and numbness</strong> in the extremities, also known as <strong>paresthesia</strong>, can signal a problem with a nerve. This may be caused by nerve root compression in the spine (<a href=\"/conditions/pinched-nerve\" class=\"text-blue-600 hover:underline\">radiculopathy</a>), peripheral nerve entrapment like <a href=\"/conditions/carpal-tunnel-syndrome\" class=\"text-blue-600 hover:underline\">carpal tunnel syndrome</a>, or systemic conditions such as diabetes. At Mountain Spine & Orthopedics, our diagnosis starts with a thorough neurologic exam, advanced imaging, and electrodiagnostic testing (EMG/NCS) to identify the precise nerve involved and determine the cause.",
        ...
        treatment: "Treatment is entirely guided by the underlying diagnosis. If the cause is spinal, care may include physical therapy referrals, anti-inflammatory medications, and targeted <a href=\"/treatments/epidural-steroid-injection\" class=\"text-blue-600 hover:underline\">epidural steroid injections</a>. If a structural issue like a <a href=\"/conditions/herniated-disc\" class=\"text-blue-600 hover:underline\">herniated disc</a> is the cause, minimally invasive surgery may be considered. For peripheral issues, treatments like wrist splinting or <a href=\"/treatments/carpal-tunnel-release\" class=\"text-blue-600 hover:underline\">carpal tunnel release</a> may be recommended.",
    ...
    },
    {
        ...
        what_sym: "Common symptoms include persistent <a href=\"/conditions/back-pain\" class=\"text-blue-600 hover:underline\">back</a> or <a href=\"/conditions/neck-pain\" class=\"text-blue-600 hover:underline\">neck pain</a>, pain that radiates down an arm or leg (<a href=\"/conditions/sciatica\" class=\"text-blue-600 hover:underline\">sciatica</a>), and <strong>numbness or tingling</strong> in the extremities. <strong>Muscle weakness</strong> and difficulty with fine motor tasks can also occur.",
    ...
    },
    {
        ...
        prevent: "While congenital flat feet cannot be prevented, you can take steps to prevent symptoms from an acquired flatfoot. Wearing supportive shoes, maintaining a healthy weight, and performing regular stretching exercises for the <a href=\"/conditions/achilles-tendonitis\" class=\"text-blue-600 hover:underline\">Achilles tendon</a> and calf muscles can all help reduce strain on the arches.",
