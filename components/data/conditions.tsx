...
import sdtarti from '@/public/sdtarti.jpg'
...
import tbcard from '@/public/tbcard.avif'
...
import aclcard from '@/public/aclcard.webp'
...
export const Conditions : ConditionInfoProp[] = [
  {
    ...
    "diagnose": "Diagnosis at Advanced Orthopedics begins with a detailed medical history and a comprehensive physical examination, followed by advanced imaging such as MRI or X ray. A complimentary MRI review allows our experts to check spinal integrity and identify any adjacent segment degeneration with accuracy.",
    "treatment": "Treatment depends on symptom severity and the underlying cause. Conservative options such as physical therapy, anti inflammatory medication, targeted injections, and lifestyle changes often provide relief. If symptoms persist, the care team may recommend minimally invasive surgery. Advanced Orthopedics always offers a free second opinion so that patients can move forward with confidence.",
  ...
  },
  {
    ...
    "pain_info": "Discomfort results from nerve pressure, inflammation, and instability in curved segments. Pain can range from mild to severe and chronic, but targeted care from Advanced Orthopedics can lower symptoms and help patients move with greater comfort.",
    ...
    "schedule": "Book a consultation with Advanced Orthopedics today to explore relief from Adult Degenerative Scoliosis. Enjoy complimentary MRI reviews, a free second opinion, and door to door transportation that supports your journey to better spinal health.",
...

  {
    ...
    "pain_info": "Back pain may vary from mild occasional soreness to severe continuous discomfort. Identifying individual triggers and following a structured plan from Advanced Orthopedics can greatly reduce symptoms and support daily comfort.",
    ...
    "schedule": "Arrange a consultation with Advanced Orthopedics today. Benefit from complimentary MRI review, a free second opinion, and convenient transportation that makes your path to relief smooth and comfortable.",
    "slug": "backpain"
  },

  {
    ...
    "pain_info": "Pain from a bulging disc can range from mild discomfort to severe debilitating sensations often worsening with certain movements or positions. Expert pain management at Advanced Orthopedics greatly improves comfort and supports better daily functioning.",
    ...
    "schedule": "Contact Advanced Orthopedics today to schedule your personalized consultation. Benefit from complimentary MRI reviews free second opinions and complementary transportation services for a smooth and effective path to relief.",
    "slug": "bulgingdisc"
  },
...

  {
    ...
    "diagnose": "Diagnosis starts with a detailed medical history and physical exam including provocative tests such as Tinels and Phalens maneuvers. Advanced Orthopedics then uses nerve conduction studies electromyography and complimentary high resolution imaging to measure median nerve compression accurately and rule out other causes",
    ...
    "schedule": "Contact Advanced Orthopedics today to book your personalized consultation. Benefit from complimentary MRI or ultrasound reviews free second opinions and car service for smooth convenient care as you recover hand function and get lasting relief from Carpal Tunnel Syndrome",
  ...
  
  {
    ...
    "schedule": "Take the first step toward better alignment and comfort by scheduling a consultation with Advanced Orthopedics. We will review your complimentary MRI provide a free second opinion and arrange car service so you can focus on reclaiming a pain free lifestyle",
...

  {
    ...
    "schedule": "If sharp back or neck pain is limiting your life schedule a consultation with Advanced Orthopedics today Benefit from a complimentary MRI review a free second opinion and door to door car service so you can focus on healing and returning to activities you love guided by a team committed to resolving disc tears quickly and effectively",
    "slug": "disctear"
  },

  {
    ...
    "prevent": "While injections quell acute inflammation long term relief comes from addressing biomechanical stressors. Advanced Orthopedics integrates core strengthening joint specific stabilization weight management and smoking cessation guidance to reduce future flare ups and prolong injection benefits",
    "schedule": "Explore targeted relief today by scheduling an appointment at Advanced Orthopedics for a complimentary MRI review expert second opinion and convenient car service. Our multidisciplinary team will determine whether anti inflammatory injections align with your goals and craft a customized plan to get you moving pain free again",
...

  {
    ...
    "schedule": "If hip pain or instability is limiting your lifestyle schedule a consultation with Advanced Orthopedics. Benefit from a complimentary MRI review thorough second opinion and convenient car service to get answers and a personalized plan for managing hip dysplasia and safeguarding joint health for years to come",
    "slug": "hipdysplasia"
  },
...

    {
        ...
        "diagnose": "Evaluation begins with a detailed medical history and a physical examination. Advanced Orthopedics then confirms the affected areas with advanced imaging such as complimentary MRI scans, creating a precise plan of care.",
        ...
        "schedule": "Book a consultation with Advanced Orthopedics today to address ongoing back or neck pain. Take advantage of our complimentary MRI review, free second opinion, and convenient transportation service for a smooth and supportive care experience.",
      forum : [
        {
          post : (
    ...
    },
    {
      ...
      "schedule": "If lower back pain is limiting your life schedule a consultation with Advanced Orthopedics today. Take advantage of a complimentary MRI review free second opinion and door to door transportation then move forward with a personalized plan to conquer lower back pain and reclaim active living",
...
Surgery is not always necessary for lower back pain. In fact, many patients experience significant relief through non-surgical treatments such as physical therapy, spinal injections, or medications that improve body mechanics and reduce inflammation. However, if conservative treatments fail or if there is significant damage to spinal discs or nerves, surgical intervention may be required. In those cases, our team specializes in minimally invasive procedures designed to reduce recovery time and improve outcomes.
    ...
    },
    {
      ...
      "schedule": "If neck or arm pain is limiting your life schedule a consultation with Advanced Orthopedics today. We will review your complimentary MRI provide a free second opinion and arrange car service so you can focus on returning to pain free motion and reliable nerve function",
    ...
    },
    {
      ...
      "pain_info": "Pain may fluctuate with neck posture and activity but neurologic symptoms can progress silently. Advanced Orthopedics blends precise decompression techniques with postoperative rehabilitation to curb pain restore nerve function and prevent irreversible cord changes",
      ...
      "schedule": "If neck pain arm tingling or balance issues are affecting your life schedule a consultation with Advanced Orthopedics today. We will review your complimentary MRI provide a free second opinion and arrange car service so you can access world class care focused on restoring spinal health and protecting your future mobility",
...

    {
      ...
      "pain_info": "Tailbone pain often intensifies after long car rides sitting on hard surfaces or sudden position changes. Advanced Orthopedics pairs ergonomic counseling with image guided interventions to reduce inflammation retrain posture and break the cycle of chronic coccygeal pain",
      ...
      "schedule": "Do not let tailbone pain dictate your day. Schedule a consultation with Advanced Orthopedics for a complimentary MRI review expert second opinion and convenient car service so you can sit move and live comfortably again",
...

    {
      ...
      "pain_info": "Postoperative pain often involves a mix of residual mechanical compression nerve hypersensitivity and central pain amplification Advanced Orthopedics integrates targeted interventions with cognitive behavioral and mindfulness techniques to recalibrate pain pathways and foster sustained relief",
      ...
      "schedule": "If spine surgery has failed to provide lasting relief schedule a consultation with Advanced Orthopedics our specialists will conduct a complimentary MRI review deliver a thorough second opinion and arrange car service guiding you toward a clear plan to confront Failed Back or Failed Neck Surgery Syndrome and regain control of your life",
...

    {
      ...
      "schedule": "If arm or leg pain is limiting your life schedule a consultation with Advanced Orthopedics. Benefit from a complimentary MRI review free second opinion and convenient transportation so you can move forward with a personalized plan to conquer foraminal stenosis and reclaim active living",
...

    {
      ...
      "pain_info": "Pain often spikes during deep hip flexion prolonged sitting or athletic pivoting then lingers as a dull ache. Advanced Orthopedics addresses both mechanical impingement and soft tissue inflammation through integrated care that rapidly reduces pain and prevents further joint damage",
      ...
      "schedule": "Don’t let hip pain sideline your active lifestyle. Schedule a consultation with Advanced Orthopedics for a complimentary MRI review expert second opinion and convenient car service then move forward with a personalized plan to resolve hip impingement and reclaim full motion",
      "slug": "hipimpingement"
    },

    {
      ...
      "body": "Kyphosis refers to an exaggerated forward curvature of the thoracic spine that can create a rounded back appearance chronic pain muscle fatigue and in severe cases breathing or digestive issues. Advanced Orthopedics combines high resolution imaging evidence based therapies and patient centered amenities including complimentary MRI reviews free second opinions and convenient car service to correct spinal alignment relieve discomfort and restore confident posture",
      "detail": "A normal thoracic spine curves gently forward balancing the neck and lower back. Degenerative disc collapse osteoporotic compression fractures Scheuermanns disease congenital vertebral anomalies or postural habits can accentuate this curve producing kyphosis. As the apex rounds supporting muscles stretch and weaken ligaments tighten and vertebral bodies may wedge anteriorly leading to pain stiffness and cosmetic concerns. Severe deformity can reduce thoracic cavity space compromising lung capacity and digestive organ function. At Advanced Orthopedics evaluation begins with a comprehensive history capturing age of onset progression speed pain pattern neurologic symptoms and impact on daily functions. A focused exam measures the kyphotic angle with a flexible ruler assesses spinal flexibility and screens for neurologic deficits. Complimentary standing long cassette X rays quantify the Cobb angle sagittal balance and pelvic parameters while high resolution MRI or CT evaluates disc integrity spinal cord space and vertebral structure. These metrics guide a tailored plan that balances non operative correction with surgical precision when needed",
      ...
      "diagnose": "Diagnosis includes standing long cassette X rays to measure the Cobb angle and assess sagittal balance and pelvic parameters along with high resolution MRI or CT scans to evaluate disc integrity and spinal cord space. Advanced Orthopedics may also conduct pulmonary function tests for high angle curves and bone density scans to identify osteoporotic fragility. Complimentary evaluations ensure all contributing factors are addressed in the final strategy",
      ...
      "pain_info": "Pain from kyphosis often stems from muscle fatigue facet overload and intervertebral disc stress. Advanced Orthopedics uses targeted injections muscle balancing therapy and when needed surgical realignment to deliver durable pain relief and functional improvement",
      ...
      "schedule": "If rounding of the back persistent mid spine pain or breathing changes concern you schedule a consultation with Advanced Orthopedics today. Enjoy a complimentary MRI review thorough second opinion and convenient car service then move forward with a customized plan to correct kyphosis reduce pain and stand tall with confidence",
      "slug": "kyphosis"
    },

    {
      ...
      "schedule": "If clicking catching or joint pain is limiting your performance schedule a consultation with Advanced Orthopedics today Receive a complimentary MRI review comprehensive second opinion and convenient transportation then move forward with a personalized strategy to heal labral tears and return to peak activity",
      "slug": "labraltears"
    },

    {
      ...
      "schedule": "If sudden joint locking or sharp pain is disrupting your routine schedule a consultation with Advanced Orthopedics. Benefit from a complimentary MRI review a comprehensive second opinion and car service so you can move forward with a clear plan to remove loose bodies and restore smooth pain free motion",
      "slug": "loosebodies"
    },
...

    {
      ...
      "schedule": "If neck pain is limiting your activities schedule a consultation with Advanced Orthopedics today. Receive a complimentary MRI review comprehensive second opinion and door to door transportation then move forward with a personalized plan to conquer neck pain and regain effortless pain free motion",
      "slug": "neckpain"
    },
