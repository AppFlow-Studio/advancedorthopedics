...
},
{
  ...
  "benefits": (
    <ul>
      ...
      <li>Preserves the hip joint, potentially delaying the need for future hip replacement.</li>
...
},
{
  ...
  "benefits": (
  <ul><li>Provides effective and often rapid relief from radiating nerve pain (sciatica or arm pain).</li><li>Is a highly minimally invasive technique with a very small incision, reducing muscle damage and scarring.</li><li>Leads to less post-operative pain and a faster recovery time.</li><li>Typically performed as an outpatient procedure, enhancing convenience.</li><li>Preserves spinal stability by targeting only the problematic disc fragment.</li><li>Offers improved visualization for the surgeon, enhancing precision.</li></ul>
),
...
},
{
  ...
  "benefits": (
  <ul><li>Provides effective diagnosis and treatment for a wide range of shoulder joint issues.</li><li>Significantly reduces shoulder pain and inflammation.</li><li>Restores joint mobility, range of motion, and overall function.</li><li>Is a minimally invasive approach, leading to smaller incisions and less scarring.</li><li>Often allows for a faster recovery time compared to open shoulder surgery.</li><li>Addresses underlying structural problems to prevent future issues.</li></ul>
),
