...
export const Doctors: DoctorProp[] = [
    {
        ...
        socials: '',
        short_bio : 'Dr. Scott Katzman is an internationally recognized, board-certified orthopedic surgeon who pioneers minimally invasive spine procedures that significantly shorten patient recovery time. A leader in the field since 1996, he specializes in outpatient disc replacement and laser surgery, and he actively educates fellow surgeons on his innovative techniques worldwide.',
    ...
    },
    {
        ...
        short_bio : 'Dr. David Cowin is a highly skilled orthopedic surgeon who provides personalized, patient-first care for a wide range of conditions affecting the spine and extremities. He specializes in both sophisticated surgical procedures and minimally invasive techniques, such as sacroiliac fusions and laser spine surgery, to restore function and relieve pain.',
        socials: '',
    ...
    },
    {
        ...
        practice: 'Spine Orthopedic Surgeon',
        socials: '',
        short_bio : 'With elite training from Princeton, Harvard, and Brown University, Dr. Christopher McCarthy is an orthopedic spine surgeon whose expertise is uniquely enhanced by a second residency in emergency medicine. This powerful combination of skills enables him to treat the most complex spinal conditions, from degenerative disorders to major trauma, with unmatched precision and compassionate care.', 
    ...
    },
    {
        ...
        short_bio : 'Dr. Douglas Slaughter is a board-certified orthopedic spine surgeon with over two decades of experience, whose unique background in mechanical engineering informs his expertise in minimally invasive and reconstructive techniques. Recognized as a 2023 Top Orthopedic Spine Surgeon, he provides highly personalized, low-impact care designed to restore mobility and relieve pain, often avoiding the need for traditional open surgery.',
