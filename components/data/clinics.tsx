...
export const clinics: ClinicsProps[] = [
  ...
  // =====================================================
  {
    ...
    [PARAGRAPH BREAK]Our Allentown orthopedic surgeons use the latest endoscopic spine surgery and arthroscopic joint techniques to minimize incisions, reduce recovery time, and deliver lasting results. PPO insurance plans and Workers' Compensation are accepted. Don't let pain limit your life — call Mountain Spine & Orthopedics in Allentown today.
    `,
    keywords: [
  ...
  },
  {
    ...
    [PARAGRAPH BREAK]Using the most advanced minimally invasive surgical techniques and on-site diagnostic imaging, our Philadelphia orthopedic surgeons work through smaller incisions than traditional open surgery. PPO insurance coverage accepted. If you're looking for an orthopedic surgeon in Philadelphia, call Mountain Spine & Orthopedics Walnut Street today.
    `,
    keywords: [
