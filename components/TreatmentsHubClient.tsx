...
import { BicepsFlexed, Bone, Footprints, Hand, User, TorusIcon, TextCursorInputIcon, Target, Activity, Droplet } from "lucide-react";
...
const filterCategories = [
  ...
  { value: "Hip", label: "Hip", icon: Target },
  { value: "Sports Medicine", label: "Sports Medicine", icon: Activity },
  ...
  return (
    <main className='w-full flex flex-col items-center justify-center bg-white h-full'>
        ...
        <div className="z-[1] flex flex-col w-full h-full text-left relative pt-20 pb-6 sm:pt-36 sm:pb-12 lg:pt-48 lg:pb-16">
          ...
          <div className="z-[2] px-4 sm:px-6 xl:px-[80px] mt-3 sm:mt-5 lg:w-full items-center justify-center">
            ...
            >
              ...
              <br className="sm:flex hidden" /> Advanced minimally invasive care for spine and joint health.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          Explore our comprehensive range of minimally invasive treatments and advanced surgical procedures.
        </p>
