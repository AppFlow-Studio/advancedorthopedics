        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#374151', marginBottom: '24px' }}> {/* text-gray-700 mb-6 */}
              ...
              <span style={{ color: '#0A50EC', fontWeight: '500' }}><a href="tel:+15612239959">(561) 223-9959</a></span>. {/* text-[#0A50EC] font-medium */}
            </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <a href="tel:+15612239959" style={{ color: '#0A50EC', textDecoration: 'underline', marginLeft: '8px' }}> {/* for half of space-x-4 */}
                Contact Us
              </a>
            </div>
          </div>
