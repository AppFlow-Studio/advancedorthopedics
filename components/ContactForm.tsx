          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>                   
                      <div className=" flex  ">
                        <span className="inline-flex items-center px-6 h-12 text-lg border border-[#DCDEE1] border-r-0 rounded-l-md bg-[#EFF5FF]">
                        ...
                        <Input placeholder="Full Name" className="h-12 text-lg rounded-l-none border-[#DCDEE1] border-l-0 bg-[#EFF5FF]" {...field} />
                      </div>                   
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                     <div className=" flex  ">
                        ...
                        <Input placeholder="Enter Email" className="h-12 text-lg rounded-l-none border-[#DCDEE1] border-l-0 bg-[#EFF5FF]" {...field} />
                      </div> 
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className=" flex  ">
                        ...
                        <Input placeholder="+1 Phone Number" className="h-12 text-lg  border-[#DCDEE1] bg-[#EFF5FF]" {...field} />
                      </div> 
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xl font-semibold">Best Time</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger className="h-12 text-lg border-black bg-white">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xl font-semibold">Date</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl className="border-black">
                          <Button
                            variant={"outline"}
                            className={cn(
                              "h-12 text-lg w-full pl-3 text-left font-normal",
