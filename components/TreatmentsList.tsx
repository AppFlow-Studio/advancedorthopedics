    ...
    <div className="w-full max-w-lg mx-auto"> {/* Optional: Container styling */}
       <div className=' flex flex-col space-y-[20px] hover:cursor-pointer mt-[32px]'>
        {AllTreatments.map((treatment, index) => {
          ...
          return (
            <Link href={`/treatments/${treatment.slug}`} key={treatment.title} className={`bg-[#FAFAFA] p-[16px] w-full flex flex-row justify-between items-center rounded-[10px] ${visibilityClasses}`} >
                <h1
                style={{
