 ...
 * 
 * BRAND SUFFIX: "Mountain Spine"  (SHARED-17 Spec 1, 2026-09-06)
 * 
 * FORMULAS:
 * - Conditions: [Condition]: Symptoms & Treatment | Mountain Spine
 * - Treatments: [Procedure]: Recovery & Candidacy | Mountain Spine
 * - Topics over 23 chars drop the modifier: [Topic] | Mountain Spine
...
/**
 * Shared title builder, SHARED-17 Spec 1.
 *
 * One suffix across the site, "| Mountain Spine", 16 characters including the
 * separator. It replaces four inconsistent suffixes, the longest of which cost 32
 * characters and did not contain the brand at all: 220 of 241 titles never said
 * "Mountain Spine", so the practice earned no brand recall from its own listings.
 *
 * Topics longer than 23 characters drop the modifier rather than truncating the
 * name, because the name is the part that matches the query.
 */
export function buildTitle(topic: string, kind: "condition" | "treatment"): string {
  const modifier = kind === "condition"
    ? ": Symptoms & Treatment"
    : ": Recovery & Candidacy";
  return topic.length <= 23
    ? `${topic}${modifier} | Mountain Spine`
    : `${topic} | Mountain Spine`;
}
...
export const conditionMetadata: Record<string, SEOMetadata> = {
  ...
  "adjacent-segment-disease": {
    metaTitle: "Adjacent Segment Disease | Mountain Spine",
  ...
  "degenerative-disc-disease": {
    metaTitle: "Degenerative Disc Disease | Mountain Spine",
  ...
  "cervical-spinal-stenosis": {
    metaTitle: "Cervical Spinal Stenosis | Mountain Spine",
  ...
  "spinal-compression-fractures": {
    metaTitle: "Spinal Compression Fractures | Mountain Spine",
  ...
  "sacroiliac-joint-dysfunction": {
    metaTitle: "Sacroiliac Joint Dysfunction | Mountain Spine",
  ...
  "back-pain": {
    metaTitle: "Back Pain: Symptoms & Treatment | Mountain Spine",
  ...
  "disc-tear": {
    metaTitle: "Disc Tear (Annular Tear) | Mountain Spine",
  ...
  "lower-back-pain": {
    metaTitle: "Lower Back Pain: Symptoms & Treatment | Mountain Spine",
  ...
  "coccydynia": {
    metaTitle: "Coccydynia (Tailbone Pain) | Mountain Spine",
  ...
  "failed-back-surgery-syndrome": {
    metaTitle: "Failed Back Surgery Syndrome | Mountain Spine",
  ...
  "aging-management": {
    metaTitle: "Orthopedic Aging Management | Mountain Spine",
  ...
  "neck-pain": {
    metaTitle: "Neck Pain: Symptoms & Treatment | Mountain Spine",
  ...
  "degenerative-disc-disease-surgery": {
    metaTitle: "Degenerative Disc Disease Surgery | Mountain Spine",
  ...
  "pseudarthrosis-revision-surgery": {
    metaTitle: "Pseudarthrosis & Revision Surgery | Mountain Spine",
...
export const treatmentMetadata: Record<string, SEOMetadata> = {
  ...
  "multilevel-degenerative-disc-disease-surgery": {
    metaTitle: "Multilevel Spinal Fusion Surgery | Mountain Spine",
  ...
  "anterior-lumbar-corpectomy-and-fusion": {
    metaTitle: "Anterior Lumbar Corpectomy & Fusion | Mountain Spine",
  ...
  "hybrid-lumbar-spine-surgery": {
    metaTitle: "Hybrid Lumbar Spine Surgery | Mountain Spine",
  ...
  "posterior-cervical-fusion-with-instrumentation-surgery": {
    metaTitle: "Posterior Cervical Fusion | Mountain Spine",
  ...
  "posterior-cervical-fusion-surgery": {
    metaTitle: "Posterior Cervical Fusion Surgery | Mountain Spine",
  ...
  "anterior-cervical-corpectomy-and-fusion": {
    metaTitle: "ACCF Surgery: Recovery & Candidacy | Mountain Spine",
  ...
  "acdf-surgery": {
    metaTitle: "ACDF Surgery: Recovery & Candidacy | Mountain Spine",
  ...
  "lumbar-disc-replacement-surgery": {
    metaTitle: "Lumbar Disc Replacement: Recovery & Candidacy | Mountain Spine",
  ...
  "artificial-disc-replacement-surgery": {
    metaTitle: "Artificial Disc Replacement | Mountain Spine",
  ...
  "cervical-disc-arthroplasty": {
    metaTitle: "Cervical Disc Arthroplasty | Mountain Spine",
  ...
  "motion-preservation-spine-surgery": {
    metaTitle: "Motion Preservation Spine Surgery | Mountain Spine",
  ...
  "total-hip-replacement": {
    metaTitle: "Total Hip Replacement: Recovery & Candidacy | Mountain Spine",
  ...
  "total-knee-replacement": {
    metaTitle: "Total Knee Replacement: Recovery & Candidacy | Mountain Spine",
  ...
  "posterior-cervical-laminoplasty": {
    metaTitle: "Posterior Cervical Laminoplasty | Mountain Spine",
  ...
  "posterior-cervical-foraminotomy-surgery": {
    metaTitle: "Posterior Cervical Foraminotomy | Mountain Spine",
  ...
  "lumbar-laminectomy-surgery": {
    metaTitle: "Lumbar Laminectomy: Recovery & Candidacy | Mountain Spine",
  ...
  "lumbar-decompression": {
    metaTitle: "Lumbar Decompression: Recovery & Candidacy | Mountain Spine",
  ...
  "lumbar-microendoscopic-discectomy-surgery": {
    metaTitle: "Microendoscopic Discectomy | Mountain Spine",
  ...
  "lumbar-microdiscectomy-surgery": {
    metaTitle: "Lumbar Microdiscectomy: Recovery & Candidacy | Mountain Spine",
  ...
  "percutaneous-discectomy": {
    metaTitle: "Percutaneous Discectomy: Recovery & Candidacy | Mountain Spine",
  ...
  "resurfacing-shoulder-replacement": {
    metaTitle: "Shoulder Resurfacing: Recovery & Candidacy | Mountain Spine",
  ...
  "hip-arthroscopy-treatment": {
    metaTitle: "Hip Arthroscopy: Recovery & Candidacy | Mountain Spine",
  ...
  "arthroscopic-knee-surgery": {
    metaTitle: "Arthroscopic Knee Surgery | Mountain Spine",
  ...
  "rotator-cuff-repair-surgery": {
    metaTitle: "Rotator Cuff Repair: Recovery & Candidacy | Mountain Spine",
  ...
  "meniscus-repair-surgery": {
    metaTitle: "Meniscus Repair Surgery: Recovery & Candidacy | Mountain Spine",
  ...
  "disc-replacement-vs-fusion-what-you-need-to-know": {
    metaTitle: "Disc Replacement vs Fusion | Mountain Spine",
  ...
  "ankle-ligament-reconstruction-surgery": {
    metaTitle: "Ankle Ligament Reconstruction | Mountain Spine",
  ...
  "axial-fusion-surgery": {
    metaTitle: "Axial Fusion Surgery (AxiaLIF) | Mountain Spine",
  ...
  "hybrid-cervical-spine-surgery": {
    metaTitle: "Hybrid Cervical Spine Surgery | Mountain Spine",
  ...
  "back-pain-treatment": {
    metaTitle: "Back Pain Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "bunion-correction-surgery": {
    metaTitle: "Bunion Correction Surgery | Mountain Spine",
  ...
  "carpal-tunnel-release": {
    metaTitle: "Carpal Tunnel Release: Recovery & Candidacy | Mountain Spine",
  ...
  "cervical-disc-replacement": {
    metaTitle: "Cervical Disc Replacement | Mountain Spine",
  ...
  "coccygectomy-tailbone-removal-surgery": {
    metaTitle: "Coccygectomy (Tailbone Removal) | Mountain Spine",
  ...
  "anti-inflammatory-injections-for-joint-and-spine-pain": {
    metaTitle: "Anti-Inflammatory Injections | Mountain Spine",
    metaDescription: "Learn how anti-inflammatory injections help reduce spine and joint pain. Non-surgical treatment options focused on targeted inflammation relief."
  },
  "aging-management": {
    metaTitle: "Aging Management: Recovery & Candidacy | Mountain Spine",
    metaDescription: "Explore orthopedic aging management options for bone health, joint preservation, and mobility. Expert care focused on maintaining quality of life."
  },
  "coccyx-nerve-ablation": {
    metaTitle: "Coccyx Nerve Ablation: Recovery & Candidacy | Mountain Spine",
    metaDescription: "Learn how coccyx nerve ablation helps reduce tailbone pain. Non-surgical treatment using radiofrequency energy for lasting relief."
  },
  "cortisone-injections-for-back-pain": {
    metaTitle: "Cortisone Injections for Back Pain | Mountain Spine",
  ...
  "degenerative-disc-disease-surgery-details": {
    metaTitle: "DDD Surgery Details: Recovery & Candidacy | Mountain Spine",
  ...
  "endoscopic-discectomy-surgery": {
    metaTitle: "Endoscopic Discectomy: Recovery & Candidacy | Mountain Spine",
  ...
  "endoscopic-foraminotomy-surgery": {
    metaTitle: "Endoscopic Foraminotomy: Recovery & Candidacy | Mountain Spine",
  ...
  "acl-reconstruction-surgery": {
    metaTitle: "ACL Reconstruction Surgery | Mountain Spine",
  ...
  "epidural-steroid-injection": {
    metaTitle: "Epidural Steroid Injection | Mountain Spine",
  ...
  "facet-ablation-rhizotomy-treatment": {
    metaTitle: "Facet Ablation (Rhizotomy) | Mountain Spine",
  ...
  "facet-block-ablation-rhizotomy-and-facet-fusion": {
    metaTitle: "Facet Block, Ablation & Fusion | Mountain Spine",
  ...
  "fracture-fixation": {
    metaTitle: "Spinal Fracture Fixation (Kyphoplasty) | Mountain Spine",
  ...
  "impar-block-treatment": {
    metaTitle: "Impar Block Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "neck-pain-treatment-and-shoulder-pain-relief": {
    metaTitle: "Neck & Shoulder Pain Treatment | Mountain Spine",
  ...
  "non-surgical-treatments-for-pain-management": {
    metaTitle: "Non-Surgical Pain Management | Mountain Spine",
  ...
  "percutaneous-carpal-tunnel-release": {
    metaTitle: "Percutaneous Carpal Tunnel Release | Mountain Spine",
  ...
  "shoulder-arthroscopy": {
    metaTitle: "Shoulder Arthroscopy: Recovery & Candidacy | Mountain Spine",
  ...
  "stem-cell-treatment": {
    metaTitle: "Stem Cell Treatment: Recovery & Candidacy | Mountain Spine",
    metaDescription: "Learn how stem cell treatment helps promote healing in joints and tendons. Regenerative orthopedic care focused on natural tissue repair."
  },
  "surgical-treatments": {
    metaTitle: "Surgical Treatments: Recovery & Candidacy | Mountain Spine",
  ...
  "trigger-finger-release": {
    metaTitle: "Trigger Finger Release: Recovery & Candidacy | Mountain Spine",
  ...
  "ankle-replacement-surgery": {
    metaTitle: "Ankle Replacement Surgery | Mountain Spine",
  ...
  "ankle-arthroscopy-minimally-invasive-surgery": {
    metaTitle: "Ankle Arthroscopy: Recovery & Candidacy | Mountain Spine",
  ...
  "slap-tear": {
    metaTitle: "SLAP Tear: Recovery & Candidacy | Mountain Spine",
  ...
  "shoulder-dislocation": {
    metaTitle: "Shoulder Dislocation: Recovery & Candidacy | Mountain Spine",
  ...
  "ac-joint-injury": {
    metaTitle: "AC Joint Injury: Recovery & Candidacy | Mountain Spine",
  ...
  "kyphoplasty": {
    metaTitle: "Kyphoplasty: Recovery & Candidacy | Mountain Spine",
  ...
  "vertebroplasty": {
    metaTitle: "Vertebroplasty: Recovery & Candidacy | Mountain Spine",
  ...
  "thoracic-spine-surgery": {
    metaTitle: "Thoracic Spine Surgery: Recovery & Candidacy | Mountain Spine",
  ...
  "si-joint-fusion": {
    metaTitle: "SI Joint Fusion: Recovery & Candidacy | Mountain Spine",
  ...
  "cervical-laminectomy": {
    metaTitle: "Cervical Laminectomy: Recovery & Candidacy | Mountain Spine",
  ...
  "chronic-pain-treatment": {
    metaTitle: "Chronic Pain Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "joint-pain-treatment": {
    metaTitle: "Joint Pain Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "arthritis-treatment": {
    metaTitle: "Arthritis Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "bursitis-treatment": {
    metaTitle: "Bursitis Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "tendonitis-treatment": {
    metaTitle: "Tendonitis Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "osteoporosis-treatment": {
    metaTitle: "Osteoporosis Treatment: Recovery & Candidacy | Mountain Spine",
  ...
  "work-injury": {
    metaTitle: "Work Injury Orthopedic Care | Mountain Spine",
  ...
  "personal-injury": {
    metaTitle: "Personal Injury Orthopedic Evaluation | Mountain Spine",
...
/**
 * Get SEO metadata for a condition by slug
 */
export function getConditionMetadata(slug: string): SEOMetadata | null {
  return conditionMetadata[slug] || null;
}

/**
 * Get SEO metadata for a treatment by slug
 */
export function getTreatmentMetadata(slug: string): SEOMetadata | null {
  return treatmentMetadata[slug] || null;
}
...
export function generateConditionMetadataFallback(title: string): SEOMetadata {
  return {
    metaTitle: buildTitle(title, "condition"),
...
/**
 * Generate fallback treatment metadata if not found in map
 */
export function generateTreatmentMetadataFallback(title: string): SEOMetadata {
  return {
    metaTitle: buildTitle(title, "treatment"),
